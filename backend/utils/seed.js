...
const seed = async () => {
  ...
  const masterAdmin = await User.create({
    name: 'Master Admin',
    email: 'admin@utccafe.com',
    password: 'Admin@1234',
    role: 'master_admin',
    phone: '9000000000',
  });
  console.log('✓ Master Admin created — admin@utccafe.com / Admin@1234');
  ...
  console.log('✓ Staff created for both franchises');
  ...
  const menuItems = [
    ...
    { name: 'Onion Rings', category: 'Snacks', price: 80, gst_rate: 5, hsn_code: '2004', isVeg: true, preparationTime: 8 },
    // Meals
    ...
    { name: 'Grilled Chicken Platter', category: 'Meals', price: 250, gst_rate: 5, hsn_code: '1601', isVeg: false, preparationTime: 22 },
    // Desserts
    ...
    { name: 'Brownie with Ice Cream', category: 'Desserts', price: 120, gst_rate: 18, hsn_code: '1905', isVeg: true, preparationTime: 5 },
    // Specials
  ...
  console.log('═══════════════════════════════════════════════');
  console.log('  MASTER ADMIN:    admin@utccafe.com / Admin@1234');
  console.log('  FRANCHISE OWNER: raj@utccafe.com   / Owner@1234 (Chennai)');
  console.log('  FRANCHISE OWNER: priya@utccafe.com / Owner@1234 (Bangalore)');
  console.log('  MANAGER:         manager1@utccafe.com / Staff@1234');
  console.log('  POS STAFF:       pos1@utccafe.com / Staff@1234');
  console.log('  KITCHEN STAFF:   kitchen1@utccafe.com / Staff@1234');
  console.log('═══════════════════════════════════════════════\n');
